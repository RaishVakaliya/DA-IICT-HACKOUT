...
const MarketplacePage = () => {
  const marketplaceItems = [
    {
      ...
      description: "Purchase verified green hydrogen credits from certified producers",
      price: "0.85",
      currency: "USD",
      credits: "1000",
    ...
    },
    {
      ...
      description: "High-quality carbon offset credits with blockchain verification",
      price: "12.50",
      currency: "USD",
      credits: "500",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-emerald-100 mb-8 max-w-3xl mx-auto">
              Trade verified environmental credits and accelerate the transition to a sustainable future
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Available Credits</h2>
          <p className="text-gray-600">Browse and purchase verified environmental credits</p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide the most transparent, secure, and efficient platform for trading environmental credits
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Verified Credits</h3>
              <p className="text-gray-600">All credits are verified by independent auditors and certified by regulatory bodies</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Blockchain-powered instant settlement with no intermediaries or delays</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Enterprise-grade security with multi-factor authentication and encrypted transactions</p>
            </div>
          </div>
        </div>
      </div>
